...
export function RouteCard({
  ...
  return (
    <motion.div
      layout
      layoutId={selected ? `route-pass-${route.id}` : undefined}
    ...
    >
      ...
      <div className="p-5">
        ...
        {/* Risk score — dominant */}
        <div
          className={cn("rounded-md border px-4 py-3 mb-4 text-center", riskBg)}
        >
          <p className="label-meta mb-1">Risk Score</p>
          <p className={cn("text-4xl font-bold tabular-nums", riskColor)}>
            {route.riskScore}
          </p>
          <p
            className={cn(
