        ...
        headers: [
          ...
          // - frame-ancestors: none (reinforces X-Frame-Options)
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.googleapis.com https://*.firebaseio.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://accounts.google.com wss://ws.sentinel-route.com",
